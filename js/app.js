(() => {
  ...
  const s = document.querySelectorAll("._animate");
  if (s.length > 0) {
    function o() {
      for (let t = 0; t < s.length; t++) {
        const e = s[t],
          ...
          i = n(e).top,
          o = 4;
        let r = window.innerHeight - a / o;
        a > window.innerHeight &&
          (r = window.innerHeight - window.innerHeight / o),
          pageYOffset > i - r && pageYOffset < i + a
            ? e.classList.add("_active")
            : e.classList.contains("_no-repeat") ||
    ...
    function n(t) {
      ...
      return { top: e.top + i, left: e.left + a };
    }
  ...
  (window.FLS = !0),
    ...
    (function () {
      ...
      if (i.length > 0) {
        ...
        t.startsWith("tab-") && (s = t.replace("tab-", "").split("-")),
          i.forEach((t, e) => {
                ...
                a.length > 0 &&
                  a.forEach((t, a) => {
                    e[a].setAttribute("data-tabs-title", ""),
                      ...
                      o && a == s[1] && e[a].classList.add("_tab-active"),
